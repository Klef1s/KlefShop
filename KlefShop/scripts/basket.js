...
window.addEventListener("click", (event) => {
  if (event.target.hasAttribute("data-addBasket")) {
    let cardCar = event.target.closest(".popup__container");
    const param = {
      id: cardCar.querySelector("[data-id]"),
      img: cardCar.querySelector(".car__image").getAttribute("data-img"),
      title: cardCar.querySelector(".popup__item__title").innerText,
      price: cardCar.querySelector(".popup__item__price").innerText,
      InnerPrice: cardCar.querySelector("[data-price]"),
      counter: cardCar.querySelector("[data-counter]"),
    };
    ...
    if (itemInBin) {
      ...
      <div class="counter">
        <div class="counter__btn" id="btn__minus">
          <img src="../img/minus.svg" />
        </div>
        <p class="counter__text">${param.counter}</p>
        <div class="counter__btn" id="btn__plus">
